...
class CheckoutController extends Controller
{
    ...
    public function checkoutManualy(Request $request)
    {
        ...
        return view('checkout-v2', $userData);
    }
    ...
    public function getComprovante(Request $request) {
        ...
        $data = [
            'ticket' => $ticket,
            'cotas' =>  $cotas,
            'cotas_innerHtml' => view('layouts.cotas-checkout', ['participante' => $participante])->render()
        ];
