...
class ProductAdminController extends Controller
{
    ...
    public function addCotaPremiada(Request $request) {
        $rifa = ModelsProduct::find($request->product_id);

        if($rifa) {
            $product->premiada = $request->cotapremiada;
            $products->save();
            return redirect()->back()->with('success', 'Cadastro da Cotas Premiadas efetuado com sucesso!');          
        } else {
           return Redirect::back()->withErrors('Erro Ao Cadastra Cotas Premiadas Verifique ');
    ...
    public function addProduct(Request $request)
    {
        ...
        Upsell::create(['product_id' => $product]);
