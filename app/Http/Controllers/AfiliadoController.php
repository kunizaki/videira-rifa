...
class AfiliadoController extends Controller
{
	...
	public function solicitarSaque()
	{
		try {
			...
			$ganhosDisponiveis = GanhosAfiliado::where('afiliado_id', '=', $afiliadoId)->where('pago', '=', 0)->whereNull('solicitacao_id')->get();
			if ($ganhosDisponiveis->isEmpty()) {
			...
			foreach ($ganhosDisponiveis as $ganho) {
				$ganho->update([
