...
Route::middleware(['check'])->group(function () {
    ...
    Route::post('upsell', 'ProductController@UpsellImpl')->name('upsell');
    ...
    Route::get('comprovante/{id}', 'ComprovanteController')->name('getComprovante');
    ...
    // comprovante pdf
    Route::get('comprovante-rifa-pdf/{id}', 'ComprovantePDFController')->name('comprovanteRifaPDF');
