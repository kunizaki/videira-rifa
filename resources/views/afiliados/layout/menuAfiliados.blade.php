                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 text-center">
                            @if (env('APP_NAME') == 'Laravel')
                                <p class="mb-0 text-muted text-medium">Desenvolvido por <a target="_blank" href="https://acshost.com.br/">ACSHost</a> | &copy; Desenvolvido por ACSHost</p>
                            @else
                                <p class="mb-0 text-muted text-medium">&copy; Desenvolvido por ACSHost.</p>
                            @endif
