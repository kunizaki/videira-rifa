...
@section('content')
    ...
    <div class="container app-main" id="app-main">
        <div class="row justify-content-center">
            <div class="col-md-6 col-12 rifas {{ $config->tema }}" style="background-color: #17A34A;">
                ...
                <div id="divCart" class="card-rifa-destaque payment-card {{ $config->tema }}">
                    <section class="row">
                        <div class="col-md-4 d-none d-md-block">
                            <img src="/products/{{ $rifaDestaque->imagem()->name }}" alt="" srcset="" class="img-fluid rounded">
                        </div>
                        <div class="col-md-8">
                            <div class="card-title">
                                <h5 class="card-title">Sorteio: {{$rifaDestaque->name}}</h5>
                                <div class="d-flex justify-content-between">
                                    <span class="card-title">Quantidade:</span>
                                    <span class="card-title">{{count($participante->numbers())}} cotas</span>
                                </div>
                                <div class="d-flex justify-content-between">
                                    <span class="card-title">Valor por Cota: </span>
                                    <span class="card-title">R$ {{$rifaDestaque->price}}</span>
                                </div>
                                <div class="d-flex justify-content-between">
                                    <span class="card-title">Cotas:</span>
                                    <span class="card-title">Disponivel após pagamento</span>
                                </div>
                            </div>
                            <div class="mt-4">
                                Valor a ser pago: R$ {{ $price }}
                            </div>
                        </div>
                    </section>
                    ...
                    <section class="row mt-5">
                        @if ($rifa->expiracao > 0)
                            <div class="text-center px-5" id="progress-bar">
                                {{-- <p class="desc"><b>Tempo restante para pagamento: </b></p> --}}
                                <span id="qrclock">
                                    Expira em: <strong><span id="qrminutes"></span> : <span id="qrseconds"></span></strong>
                                </span>
                                <div class="progress" role="progressbar" aria-label="Animated striped example" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">
                                    <div id="qrprogress" class="progress-bar progress-bar-striped progress-bar-animated" style="width: 100%"></div>
                                </div>
                            </div>
                        @endif
                    </section>
        ...
        <br>    
        <div class="card-rifa-destaque detalhes-compra d-none {{ $config->tema }}" style="margin-top: 10px;" id="card-comp">
            <label>
    ...
    <script>
        ...
        document.getElementById('codepix').addEventListener('click', function() {
