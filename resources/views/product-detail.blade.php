    ...
    <div class="container detail">
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 rifa-content {{ $config->tema }}">
                ...
                @endif
                @include('rifas.descricao_produto')
            </div>
        </div>
        <br>
        ...
        function validarQtd() {
            ...
            if(qtd > 10000){
                Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
                    text: 'limite Máximo de compra é 10.000 números! mas poderá comprar somente {{ $productModel->maximo }} por vez! ',
                });
                return;
            }
            var minimo = '{{ $productModel->minimo }}'
            var maximo = '{{ $productModel->maximo }}'
            
            if (qtd < minimo) {
                Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
                    text: `A compra mínima para essa ação é de {{ $productModel->minimo }} numeros!`,
                });
                return;
            }
            ...
            if (qtd > maximo) {
                Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
                    text: `A compra máxima para essa ação é de {{ $productModel->maximo }} numeros!`,
                });
                return;
            }
