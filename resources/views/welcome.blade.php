                        ...
                        @endforeach
                         ...
                         @foreach ($ganhadores as $ganhador)
                            <div class="ganhador {{ $config->tema }}"
                                ...
                                <div class="ganhador-foto">
                                    @if ($ganhador->foto)
                                        <img src="{{ asset($ganhador->foto) }}" class="" alt=""
                                            style="min-height: 60px;max-height: 20px;border-radius:5px;">
                                    @else
                                ...
                                <div class="ganhador-desc {{ $config->tema }}">
                                    <p><h3>{{ $ganhador->ganhador }}</h3>
                                     <strong>{{ $ganhador->descricao }}</strong><br> número da sorte <span
                                            class="badge bg-success p-1"
                                            style="border-radius: 5px;">{{ $ganhador->cota }}</span>
                                        <strong>Sorteio: </strong>
                                        {{ date('d/m/Y', strtotime($ganhador->rifa()->draw_date)) }}
                                    </p>
                                </div>
                                <div class="card-produto-item--arrow">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="70" fill="currentColor" class="bi bi-chevron-compact-right" viewBox="0 0 16 16">
