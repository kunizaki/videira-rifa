...
<head>
    ...
    <style>
        ...
        #loadingSystem {
            background: rgba(139, 139, 139, 0.5) url("../../images/loading.gif") no-repeat scroll center center;
...
<body>
    ...
    <nav class="navbar navbar-expand-lg  fixed-top px-0 py-3 " style="background-color:#000000;">
                    ...
                    <a href="#" data-bs-toggle="modal" data-bs-target="#consultar-reservas"
                        ...
                        @else
                            <i class="bi bi-bag-check-fill"
                                style="margin-top: 10px;font-size: 30px;color: rgb(221, 221, 221) !important; opacity: 1;"></i>
                        @endif
                    </a>
                        ...
                        <nav class="nav-vertical nav-submenu font-xs mb-2">
                            <ul>
                                ...
                                <li><a alt="Termos de uso" class="text-white" href="{{ route('politica') }}"><i
                                            class="icone bi bi-blockquote-right"></i><span>Política de
                                            Privacidade</span></a></li>
                                </li>
                            </ul>
                        </nav>
                        <div class="text-center">
                            <a href="/login" class="btn btn-warning w-100 rounded-pill">
    ...
    <div class="row  d-flex mt-5">
       ...
       <a href="https://chat.whatsapp.com/EjrmnV9LpMG" id="btn-ctt-whatsapp" target="_blank" class="visible"><label id="wa_msg_ctt"><i class="bi bi-whatsapp"></i> GRUPO</label></a>
...
@endif
       ...
       <a href="https://t.me/+kseyi6M" style="right: 0;
    bottom: 0;
    position: fixed;
        ...
        <div class="modal-dialog">
            <div class="modal-content model-reserva" ">
                <div class="modal-header modal-v2" style="">
                    <h5 class="modal-title" id="exampleModalLabel" style="">CONSULTAR RESERVAS</h5>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close"
                        style="">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body modal-v2 model-v2-border" style="">
                    <div class="row">
                        <div class="col-md-12">
       ...
       @if (@$data['social']->group_whats != null)
                ...
                @if (@$data['social']->instagram != null)
                    <a href="https://www.instagram.com/{{ @$data['social']->instagram }}"
                        class="botao-flutuante-insta" target="_blank">
                        <i style="margin-top:8px" class="fab fa-instagram"></i>
                    </a>
                @endif
                @if (@$data['user']->telephone != null)
                    <a href="https://api.whatsapp.com/send?phone=55{{ @$data['user']->telephone }}"
                        class="botao-flutuante-suporte bg-not-mob-white bg-transparent bg-md-white text-black fw-bold border border-2 border-black"
                        target="_blank">
                        <span class="text-uppercase" style="font-size: 12px;">suporte</span>
