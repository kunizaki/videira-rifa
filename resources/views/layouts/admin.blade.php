...
<body class="sidebar-mini layout-fixed layout-navbar-fixed" style="height: auto;">
    ...
    <div class="wrapper">
        <!-- Navbar -->
        <nav class="main-header navbar navbar-expand navbar-white navbar-light " style="background: #395976">
            <!-- Left navbar links -->
            <ul class="navbar-nav">
                <li class="nav-item">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background: #234667">
            <!-- Brand Logo -->
            <a href="../../home" class="brand-link text-center"
                style="background: #1f3349; text-decoration: none">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item menu-open">
                            <a href="#" class="nav-link active" style="background: #1f3349; text-decoration: none">
