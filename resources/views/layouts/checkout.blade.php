            ...
            <div class="col-md-6 col-12 d-flex justify-content-between align-items-center">
                <div>
                    <a class="" href="{{ route('inicio') }}"
                        ...
                        @if (@$data['social']->logo)
                            <img src="{{ asset('products/' . @$data['social']->logo) }}" alt="" width="185"
                                height="55" />
                        @else
                            Perfect Rifas
                        @endif
...
@endif
    ...
    @if (@$data['user']->telephone != null)
        <a href="https://api.whatsapp.com/send?phone={{ @$data['user']->telephone }}" class="botao-flutuante-suporte bg-not-mob-white bg-transparent bg-md-white text-black fw-bold border border-2 border-black" target="_blank">
