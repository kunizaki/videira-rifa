...
<div class="modal fade" id="staticBackdrop" data-backdrop="MODA" data-keyboard="false" tabindex="-1"
    ...
    @if($upsell && $upsell->desconto > 0)
        <form action="{{ route('upsell') }}" id="form-checkout" method="POST">
    @else
        <form action="{{ route('bookProductManualy') }}" id="form-checkout" method="POST">
    @endif
            {{ csrf_field() }}
            <div class="modal-content" style="border: none;">
                <div class="modal-header" style="background-color: #066399;color: #fff;">
                ...
                <div class="modal-body" style="background: ;color: #fff;">
                    ...
                    <div class="form-group"
                        style="background-color: #cff4fc;padding: 5px;border-radius: 10px;color: #055160;">
                        <span><i class="bi bi-check-circle"></i> Você está adquirindo <strong id="qtd-checkout"></strong> cota(s) da ação entre amigos
                            <strong id="rifa-checkout"></strong> </span>
                    </div>
                    ...
                    <div class="form-group" id="div-telefone">
                        ...
                        <input type="text" class="form-control numbermask keydown"
                            style="background-color: #fff;border:solid 1px !important; none;color:#333333 !important;" name="telephone" id="telephone1"
                    ...
                    <div class="form-group d-none" id="div-nome">
                        ...
                        <input type="text" class="form-control"
                            style="background-color: #fff;border:solid 1px !important; none;color:#333333 !important;" name="name" id="name"
                            required>
                    </div>
                    ...
                    <button class="btn btn-block btn-success" id="btn-checkout-action" onclick="checkCustomer()"
                        type="button"><strong id="btn-checkout">Continuar <i class="bi bi-arrow-right-circle"></i></strong></button>

                    <center>
                        <button class="btn btn-sm btn-outline-secondary mt-2 d-none" id="btn-alterar"
                            onclick="cleanStorage()">Alterar Telefone</button>
                    </center>
                    <input type="hidden" id="promo" name="promo">
...
<script>
    ...
    function cleanStorage() {
        localStorage.removeItem('rifa_users');
        clearModal()
    }
    ...
    function checkCustomer() {
        ...
        const customer = JSON.parse(localStorage.getItem("rifa_users"));
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.customer == null) {
                        ...
                        loading()
                        localStorage.setItem('rifa_users', JSON.stringify(response.customer))
    ...
    function findCustomer(customer) {
        ...
        document.getElementById('telephone1').value = customer.telephone;
        ...
        document.getElementById('btn-checkout-action')
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
    ...
    <div class="modal-dialog">
        <div class="modal-content model-reserva">
            <div class="modal-header modal-v2" style="">
                <h5 class="modal-title" id="exampleModalLabel">CONSULTAR RESERVAS</h5>
                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close"
                    style="color: #fff;">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body modal-v2 model-v2-border">
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{ route('consultingReservation') }}" method="POST" style="display: flex;">
                            ...
                            <button type="submit" class="btn btn-green" style="background-color: #198754; color: #fff;">Buscar</button>
                        </form>
                    </div>
                </div>
            </div>
